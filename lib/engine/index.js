...
function Engine(app) {
  ...
  this.providers = {
    ...
    , facebook: new Facebook( config.auth.facebook )
    , twitter: new Twitter( config.auth.twitter )
  }
  this.providers.twitter.config.username = config.profiles.twitter;
